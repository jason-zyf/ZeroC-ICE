...
final class _AMD_IDataServiceAccessor_UnSubscribeImpl extends IceInternal.IncomingAsync implements AMD_IDataServiceAccessor_UnSubscribeImpl
{
    public _AMD_IDataServiceAccessor_UnSubscribeImpl(IceInternal.Incoming in)
    {
        super(in);
    }
