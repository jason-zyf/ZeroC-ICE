...
final class _AMD_IDataServiceAccessor_Register extends IceInternal.IncomingAsync implements AMD_IDataServiceAccessor_Register
{
    public _AMD_IDataServiceAccessor_Register(IceInternal.Incoming in)
    {
        super(in);
    }
