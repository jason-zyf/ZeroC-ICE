...
public final class HelloIPrxHelper extends Ice.ObjectPrxHelperBase implements HelloIPrx
{
    ...
    private Ice.AsyncResult begin_hello(String instr, 
                                        ...
                                        IceInternal.Functional_BoolCallback __sentCb)
    {
        class CB extends IceInternal.Functional_TwowayCallback implements slice2java._Callback_HelloI_hello
        {
    ...
    static public void __hello_completed(slice2java._Callback_HelloI_hello __cb, Ice.AsyncResult __result)
    {
