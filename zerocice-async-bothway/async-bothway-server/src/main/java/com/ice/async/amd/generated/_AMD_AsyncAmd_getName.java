...
final class _AMD_AsyncAmd_getName extends IceInternal.IncomingAsync implements AMD_AsyncAmd_getName
{
    public _AMD_AsyncAmd_getName(IceInternal.Incoming in)
    {
        super(in);
    }
