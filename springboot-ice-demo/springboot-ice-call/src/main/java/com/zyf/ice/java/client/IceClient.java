package com.zyf.ice.java.client;

import Ice.Identity;
import com.zyf.ice.servant.ClientServant;
...
public class IceClient {
     ...
     * 服务端点
     */
    private static final String SERVER_ENDPOINT = "tcp -h 127.0.0.1 -p 10076";
...
//                    System.out.println("sn1: server heartbeat...."+System.currentTimeMillis());
//                }
//
//                @Override
//                public void closed(Ice.Connection c) {
//                    System.out.println("sn1:" + " " + "closed....");
//                }
//            });
            // 每30/2 s向对方做心跳
