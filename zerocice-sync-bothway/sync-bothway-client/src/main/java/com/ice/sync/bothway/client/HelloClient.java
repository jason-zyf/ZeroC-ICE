package com.ice.sync.bothway.client;

import Ice.Communicator;
import Ice.ObjectPrx;
import Ice.Util;
import com.ice.sync.bothway.generated.HelloPrx;
import com.ice.sync.bothway.generated.HelloPrxHelper;
...
public class HelloClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ObjectPrx base = ic.stringToProxy("HelloPrinter:default -p 7788");
